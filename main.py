...
with col1:   
    #---------  Описание ------
    st.markdown("Добро пожаловать! Вас приветствует сервис расчета эффективной доходности облигации! Значение доходности - это важнейший критерий при принятии решения о покупке облигации и здесь вы можете получить это значение.")
    st.markdown("В отличие от других аналогичных сервисов, на данном ресурсе акцент сделан на точность учета всех денежных потоков, включая комиссию при покупке и подоходный налог.")
        ...
        if button1:
            ...
            if mat_date == "":         
                ...
                with col2: 
                    ...
                    st.markdown("**Все денежные потоки (знак суммы соответствует направлению)**")    
