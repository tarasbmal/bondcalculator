...
with col1:   
    #---------  Описание ------
    st.markdown("Добро пожаловать на сервис расчета эффективной доходности облигации ! Значение доходности - это важнейший критерий при принятии решения о покупке облигации.")
